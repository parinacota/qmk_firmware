...
//                                       +-------------+=============+-------------+-------------+=============+-------------+     
    ...
    [_COD] = LAYOUT_36keys(
//-----------+-------------+-------------+-------------+-------------+                           +-------------+-------------+-------------+-------------+-------------+
AZ_DQUO,      AZ_LABK,      AZ_RABK,      AZ_DLR,       AZ_PERC,                                  AZ_MINS,      AZ_7,         AZ_8,         AZ_9,         AZ_BSLH,   
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
AZ_LCBR,      AZ_LPRN,      AZ_RPRN,      AZ_RCBR,      AZ_EQL,                                   AZ_PLUS,      AZ_4,         AZ_5,         AZ_6,         AZ_ASTR,  
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
TD(TD6_QUOT_GRV),AZ_LBRC,   AZ_RBRC,      AZ_PIPE,      AZ_HASH,                                  TD(TD5_COMM_DOT),AZ_1,      AZ_2,         AZ_3,         AZ_SLSH,
//-----------+-------------+-------------+-------------+=============+-------------+-------------+=============+-------------+-------------+-------------+-------------+
...
//                                       +-------------+=============+-------------+-------------+=============+-------------+     
    ...
    [_DIR] = LAYOUT_36keys(
//-----------+-------------+-------------+-------------+-------------+                           +-------------+-------------+-------------+-------------+-------------+
KC_TAB,       XXXXXXX,      KC_SPC,       AZ_CIR,       XXXXXXX,                                   XXXXXXX,      XXXXXXX,       XXXXXXX,      XXXXXXX,     XXXXXXX,   
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
AZ_AT,        AZ_DLR,       AZ_EURO,      AZ_AMPR,      AZ_TIL,                                   KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT,      XXXXXXX,
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
