...
enum layers { _BAS, _SHF, _1DK, _SDK, _COD, _DIR, _FCT, _MSE, _OTH };
...
void dance_flsh_each(tap_dance_state_t *state, void *user_data) {
  switch (state->count) {
      case 1:
          leds_seths_at(HS_ORANGE, LED_LEFT);
          leds_seths_at(HS_ORANGE, LED_RIGHT);
...
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
LALT_T(AZ_Z), AZ_X ,        AZ_MINS,      AZ_V,         LT(_FCT,AZ_B),                            AZ_DOT,       AZ_H,         AZ_G,         AZ_COMM,      AZ_K,
//-----------+-------------+-------------+-------------+=============+-------------+-------------+=============+-------------+-------------+-------------+-------------+
                                        TD(TD1_CTL_GUI),LM(_SHF, MOD_LSFT),MO(_COD),TD(TD2_BSPC_MS3),LT(_DIR,KC_SPC),KC_ENT        
//                                       +-------------+=============+-------------+-------------+=============+-------------+     
    ),
...
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
AZ_AE,        AZ_SUP2,      AZ_QCADR,     AZ_SCADR,     AZ_CADR,                                  AZ_ETC,       AZ_https,     AZ_SUP2,      AZ_SUP3,      AZ_COPYR,
//-----------+-------------+-------------+-------------+=============+-------------+-------------+=============+-------------+-------------+-------------+-------------+
...
//                                       +-------------+=============+-------------+-------------+=============+-------------+     
    ...
    [_COD] = LAYOUT_36keys(
//-----------+-------------+-------------+-------------+-------------+                           +-------------+-------------+-------------+-------------+-------------+
AZ_DQUO,      AZ_LABK,      AZ_RABK,      AZ_AMPR,      AZ_HASH,                                  AZ_MINS,      AZ_7,         AZ_8,         AZ_9,         AZ_BSLH,   
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
AZ_LCBR,      AZ_LPRN,      AZ_RPRN,      AZ_RCBR,      AZ_PIPE,                                  AZ_PLUS,      AZ_4,         AZ_5,         AZ_6,         AZ_ASTR,  
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
TD(TD6_QUOT_GRV),AZ_LBRC,   AZ_RBRC,      AZ_PERC,      AZ_EQL,                                   TD(TD5_COMM_DOT),AZ_1,      AZ_2,         AZ_3,         AZ_SLSH,
//-----------+-------------+-------------+-------------+=============+-------------+-------------+=============+-------------+-------------+-------------+-------------+
                                          _______,      XXXXXXX,      XXXXXXX,      _______,      AZ_0,         _______        
//                                       +-------------+=============+-------------+-------------+=============+-------------+     
    ),

    [_DIR] = LAYOUT_36keys(
//-----------+-------------+-------------+-------------+-------------+                           +-------------+-------------+-------------+-------------+-------------+
KC_TAB,       XXXXXXX,      XXXXXXX,      AZ_CIR,       XXXXXXX,                                   XXXXXXX,      XXXXXXX,       XXXXXXX,      XXXXXXX,     XXXXXXX,   
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
AZ_AT,        AZ_DLR,       AZ_EURO,      XXXXXXX,      AZ_TIL,                                   KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT,      XXXXXXX,
//-----------+-------------+-------------+=============+-------------+                           +-------------+=============+-------------+-------------+-------------+ 
A(KC_TAB),    AZ_SML1,      AZ_SML2,      AZ_SML3,      XXXXXXX,                                  KC_HOME,      KC_PGDN,      KC_PGUP,      KC_END,       XXXXXXX,
//-----------+-------------+-------------+-------------+=============+-------------+-------------+=============+-------------+-------------+-------------+-------------+
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (keycode == MS_BTN1 || keycode == MS_BTN2) {
    ...
    //enable _DIR when MS_BTN1 is hold
    //if (keycode == MS_BTN1) {
    //  if (record->event.pressed) layer_on(_DIR);1234
    //else layer_off(_DIR);
  //}
  }
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  //       layer_state_cmp(state,_DIR), layer_state_cmp(state,_FCT), layer_state_cmp(state,_MSE));
    ...
    } else if (layer_state_cmp(state, _DIR)) {
